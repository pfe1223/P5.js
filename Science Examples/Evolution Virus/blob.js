function Blob(loc, dna) {
  ...
  this.display = function() {
    ellipseMode(CENTER);
    if (this.virus) {
      stroke(255, 239, 20, this.health);
      fill(255, 239, 20, this.health);
    } else {
  ...
  this.touching = function(blob) {
    //console.log("touching");
    let d = dist(this.position.x, this.position.y, blob.position.x, blob.position.y);
    return d < (this.r / 2 + blob.r / 2);
  }
